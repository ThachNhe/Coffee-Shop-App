...
// import { TouchableOpacity, StyleSheet, Text, View, Dimensions, FlatList } from 'react-native';
...
// MapboxGL.setAccessToken('ycmQvDOcmy51XgAotb5jyoJWW3IyhNqCjMxj7Lia');

// const windowWidth = Dimensions.get('window').width;

// const AutoCompleteScreen = ({ navigation }) => {
//     const [loadMap, setLoadMap] = useState('https://tiles.goong.io/assets/goong_map_web.json?api_key=api_key');
...
//                     }}
//                 >
//                     <Icon name="arrow-back-outline" type="ionicon" color={'#FFF'} size={20} />
//                 </TouchableOpacity>
...
//                     <Icon name="location-outline" type="ionicon" color={'#959498'} size={12} />
...
//             {(insets) => (
//                 <>
//                     {/* <GeneralStatusBar backgroundColor={'transparent'} barStyle="transparent" /> */}
//                     <SafeAreaView
//                         style={{
...
//                                 zoomEnabled={true}
//                             >
//                                 <MapboxGL.Camera ref={camera} zoomLevel={zoomLevel} centerCoordinate={coordinates} />
//                                 {locations.map((item) => (
